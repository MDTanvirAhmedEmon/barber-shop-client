...
import { useCreateBarberMutation } from "@/redux/features/barber/barberApi";
...
const CreateBarber = () => {
  ...
  const [createBarber, {data, isLoading}] = useCreateBarberMutation();
  console.log(data);
  if(data) {
  ...
  return (
    <div className="w-auto md:w-auto mx-24 mt-20 px-4 md:px-10 py-14 shadow-xl bg-[#ffffffb5] rounded-lg">
      <p className="text-3xl text-center font-bold">Create New Barber</p>
